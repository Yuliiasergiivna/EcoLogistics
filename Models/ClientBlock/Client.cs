...
namespace EcoLogistics.Models.ClientBlock
{
    public class Client
    {
        ...
        [MaxLength(100, ErrorMessage = "Le numéro d'entreprise ne peut pas dépasser 100 caractères.")]
        public string? Numero_entreprise { get; set; }
        [DisplayName("BE d'entreprise: ")]
        [MaxLength(255, ErrorMessage = "Le BE d'entreprise ne peut pas dépasser 255 caractères")]
