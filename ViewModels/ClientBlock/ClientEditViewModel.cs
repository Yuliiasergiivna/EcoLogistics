...
namespace EcoLogistics.ViewModels.ClientBlock
{
    public class ClientEditViewModel
    {
        ...
        [MaxLength(100, ErrorMessage = "Le site internet ne peut pas dépasser 100 caractères.")]
        public string? Siege_Site_internet { get; set; }

        [DisplayName("Secteur d'activité: ")]
        [MaxLength(64, ErrorMessage = "Le secteur d'activité ne peut pas dépasser 64 caractères.")]
